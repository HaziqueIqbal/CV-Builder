...
function addContacts(){
    let getId = document.getElementById("addingContact");

    let title = document.createElement("div");
    title.classList.add("wrap-input100");
    title.classList.add("validate-input");
    title.classList.add("rs1-wrap-input100")
    let title_span = document.createElement("span");
    title_span.setAttribute("class", "label-input100");
    title_span.innerHTML = "Enter contact title *";
    let input = document.createElement("input");
    input.classList.add("input100");
    input.classList.add("c1");
    input.setAttribute("type", "text");
    input.setAttribute("name", "contactTitle");
    input.setAttribute("placeholder","Enter title");
    title.appendChild(title_span);
    title.appendChild(input);
    ...
    title1.classList.add("wrap-input100");
    title1.classList.add("validate-input");
    title1.classList.add("rs1-wrap-input100")
    let title_span1 = document.createElement("span");
    title_span1.setAttribute("class", "label-input100");
    title_span1.innerHTML = "Enter details *";
    let input1 = document.createElement("input");
    input1.classList.add("input100");
    input1.classList.add("c2");
    input1.setAttribute("type", "text");
    input1.setAttribute("name", "contactDetails");
    input1.setAttribute("placeholder","Enter here");
    title1.appendChild(title_span1);
    title1.appendChild(input1);

    let title2 = document.createElement("div");
    title2.classList.add("wrap-input100");
    let title_span2 = document.createElement("span");
    title_span2.setAttribute("class", "label-input100");
    title_span2.innerHTML = "Enter link";
    let input2 = document.createElement("input");
    input2.classList.add("input100");
    input2.classList.add("c3");
    input2.setAttribute("type", "text");
    input2.setAttribute("name", "contactLink");
    input2.setAttribute("placeholder","Enter here");
    title2.appendChild(title_span2);
    title2.appendChild(input2);

    getId.insertAdjacentElement("beforebegin", title);
    getId.insertAdjacentElement("beforebegin", title1);
    getId.insertAdjacentElement("beforebegin", title2);
}
